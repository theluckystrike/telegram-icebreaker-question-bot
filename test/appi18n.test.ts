...
const APP_KEYS = ["app_title","app_loading","app_moreApps","app_today","app_empty","app_group","app_shareChat","app_shareStory","app_storyText","app_shareFail","app_errNoInit","app_errExpired","app_errBadSig","app_unlockPro","app_proOneTime","app_proMonthly","app_payDone","app_payCancelled","app_payFailed"];
/** app_* keys rendered as a button: Telegram truncates a long label on narrow screens. */
const BUTTON_KEYS = ["app_shareChat","app_shareStory","app_unlockPro","app_proOneTime","app_proMonthly"];
